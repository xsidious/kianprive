export const membershipPolicySummary = [
...
export const medicalDisclaimerParagraphs = [
...
export const policiesFooterNote = {
  tagline: "KIAN Privé — Your health. Your sanctuary. Your KIAN Privé.",
  legal:
