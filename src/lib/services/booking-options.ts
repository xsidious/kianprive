...
export const bookingServiceOptions: BookingServiceOption[] = [
  ...
  bookingOption("lab-panel-essential", 224, 179, 30),
  bookingOption("lab-panel-metabolic", 324, 259, 30),
  bookingOption("lab-panel-hormone", 449, 359, 30),
  bookingOption("lab-panel-longevity", 599, 479, 30),
  bookingOption("lab-panel-executive", 1099, 879, 45),
