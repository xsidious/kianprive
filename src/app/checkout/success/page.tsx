...
function SuccessContent() {
  ...
  return (
    <SectionWrapper className="py-16">
      <div className="mx-auto max-w-xl rounded-sm border border-[#b78d4b2d] bg-white p-8 text-center shadow-[0_20px_50px_-38px_rgba(66,45,14,0.45)]">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <Link href="/shop" className="rounded-sm bg-[#b78d4b] px-5 py-2 text-sm text-white">
            Continue Shopping
          </Link>
          <Link href="/contact" className="rounded-sm border border-[#b78d4b70] bg-[#fffaf2] px-5 py-2 text-sm text-[#3b3024]">
            Contact Concierge
          </Link>
        </div>
      </div>
