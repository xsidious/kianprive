...
export default function TermsAndConditionsPage() {
  return (
    <SectionWrapper>
      ...
      <p className="mt-4 max-w-4xl text-sm text-[#e9deca]">
        Welcome to the KIAN Retreats website. By accessing and using this website, you agree to be bound by these Terms and Conditions.
      </p>

      <div className="mt-10 space-y-8 text-[#f2eadbcc]">
        <section className="rounded-3xl border border-[#d7b67666] bg-[#14110f] p-6">
          <h2 className="text-2xl text-[#f3ead8]">1. General Use</h2>
        ...
        <section className="rounded-3xl border border-[#d7b67666] bg-[#14110f] p-6">
          <h2 className="text-2xl text-[#f3ead8]">2. Booking and Payment</h2>
          <h3 className="mt-4 text-lg text-[#e8dec9]">Retreat Package Payment Policy</h3>
        ...
        <section className="rounded-3xl border border-[#d7b67666] bg-[#14110f] p-6">
          <h2 className="text-2xl text-[#f3ead8]">3. Cancellations and Refunds</h2>
          <h3 className="mt-4 text-lg text-[#e8dec9]">Cancellation Policy</h3>
          <ul className="mt-3 list-disc space-y-2 pl-6">
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">Guest Cancellation Policy</h3>
          <ul className="mt-3 list-disc space-y-2 pl-6">
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">Credit and Forfeiture Schedule</h3>
          <ul className="mt-3 list-disc space-y-2 pl-6">
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">Travel Insurance</h3>
          <ul className="mt-3 list-disc space-y-2 pl-6">
        ...
        <section className="rounded-3xl border border-[#d7b67666] bg-[#14110f] p-6">
          <h2 className="text-2xl text-[#f3ead8]">4. Disclaimers and Limitations</h2>
          <ul className="mt-4 list-disc space-y-2 pl-6">
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">Pre-Existing Condition Disclosure Policy</h3>
        ...
        <section className="rounded-3xl border border-[#d7b67666] bg-[#14110f] p-6">
          <h2 className="text-2xl text-[#f3ead8]">5. Governing Law and Jurisdiction</h2>
          <ul className="mt-4 list-disc space-y-2 pl-6">
        ...
        <section className="rounded-3xl border border-[#d7b67666] bg-[#14110f] p-6">
          <h2 className="text-3xl text-[#f3ead8]">Privacy Policy</h2>
          <h3 className="mt-4 text-lg text-[#e8dec9]">1. Information Collection</h3>
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">2. Data Security</h3>
          <ul className="mt-2 list-disc space-y-2 pl-6">
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">3. Data Sharing</h3>
          <ul className="mt-2 list-disc space-y-2 pl-6">
            <li>
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">4. Marketing Opt-In</h3>
          <ul className="mt-2 list-disc space-y-2 pl-6">
        ...
        <section className="rounded-3xl border border-[#d7b67666] bg-[#14110f] p-6">
          <h2 className="text-3xl text-[#f3ead8]">Event Guarantees</h2>
          <h3 className="mt-4 text-lg text-[#e8dec9]">1. Accommodation</h3>
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">2. Activities</h3>
          <p className="mt-2 leading-relaxed">
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">3. Speakers and Experts</h3>
          <p className="mt-2 leading-relaxed">
          ...
          <h3 className="mt-6 text-lg text-[#e8dec9]">4. Overall Experience</h3>
          <p className="mt-2 leading-relaxed">
