  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-sm border border-[#b78d4b2d] bg-white p-5">
        ...
        >
          <input name="to" type="email" placeholder="Recipient email" className="rounded-sm border border-[#b78d4b35] bg-[#fffaf4] p-3" required />
          <input name="subject" placeholder="Subject" className="rounded-sm border border-[#b78d4b35] bg-[#fffaf4] p-3" required />
          <textarea name="message" placeholder="Message" className="min-h-[150px] rounded-sm border border-[#b78d4b35] bg-[#fffaf4] p-3" required />
          <button className="rounded-sm bg-[#b78d4b] px-5 py-2 text-sm text-white">Send Email</button>
        </form>
